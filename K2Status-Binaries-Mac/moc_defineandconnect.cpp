...
#include "../src/defineandconnect.h"
...
struct qt_meta_stringdata_DefineAndConnect_t {
    QByteArrayData data[8];
    char stringdata0[92];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DefineAndConnect_t, stringdata0) + ofs \
...
static const uint qt_meta_data_DefineAndConnect[] = {
...
void DefineAndConnect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DefineAndConnect *_t = static_cast<DefineAndConnect *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->endingsig((*reinterpret_cast< Config(*)>(_a[1]))); break;
        ...
        {
            typedef void (DefineAndConnect::*_t)(Config & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DefineAndConnect::endingsig)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject *DefineAndConnect::metaObject() const
{
...
void *DefineAndConnect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DefineAndConnect.stringdata0))
        return static_cast<void*>(const_cast< DefineAndConnect*>(this));
    return QDialog::qt_metacast(_clname);
}

int DefineAndConnect::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
